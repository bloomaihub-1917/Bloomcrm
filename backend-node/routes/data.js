  ...
  */
  ...
  exhibitor_items: {
    ...
    columns: ['id', 'exhibitor_id', 'category', 'name', 'qty', 'unit_price', 'amount', 'currency', 'note', 'sort_order',
      'catalog_id', 'billable', 'shared_ref', 'received_at', 'received_note', 'due_at', 'done_at',
  ...
  speakers: {
    ...
    columns: ['id', 'event_id', 'contact_id', 'name_snapshot', 'name_en',
      ...
      'bio_edu_ko', 'bio_edu_en', 'bio_awards_ko', 'bio_awards_en',
      'bio_credentials_ko', 'bio_credentials_en', 'bio_teaching_ko', 'bio_teaching_en',
      'bio_affil_ko', 'bio_affil_en', 'bio_pubs_ko', 'bio_pubs_en', 'languages',
      'cv_file', 'cv_received_at',
      'profile_received_at',
  ...
  session_speakers: {
    ...
    columns: ['id', 'event_id', 'session_id', 'speaker_id', 'seq', 'role', 'lang',
      ...
      'keywords', 'talk_format', 'discussion',
